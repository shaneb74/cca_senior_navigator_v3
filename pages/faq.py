...
def _build_suggested_questions(active_flags: Set[str], asked_questions: List[str]) -> List[Dict[str, Any]]:
...
def _get_top_3_suggestions() -> List[str]:
    ...
    if len(question_pool) < 3:
        ...
        question_pool = _build_suggested_questions(active_flags, st.session_state["ai_asked_questions"])
