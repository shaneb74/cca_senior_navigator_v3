...
def _render_unified_audience_selection() -> None:
    """Unified audience selection with two-pill toggle and relationship dropdown.
    
    Matches Screenshot #1 visual layout (two-pill master design) while preserving
    relationship dropdown functionality from Screenshot #2.
    """
    _inject_welcome_css()
