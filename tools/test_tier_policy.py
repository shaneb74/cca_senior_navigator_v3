...
def test_tier_policy():
    ...
    print("✓ Test 1 passed: LLM tier not allowed -> keep det")
    ...
    print("✓ Test 2 passed: Risky behaviors -> keep MC")
    ...
    print("✓ Test 3 passed: De-overscore accepts AL")
    ...
    print("✓ Test 4 passed: Confident LLM accepted")
    ...
    print("✓ Test 5 passed: Low confidence -> keep det")
