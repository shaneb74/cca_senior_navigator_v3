...
def render():
    ...
    with col_center:
        ...
        st.markdown('<p class="hero-subtitle">Learn how Senior Navigator helps families explore care options and plan confidently for the future.</p>', unsafe_allow_html=True)
