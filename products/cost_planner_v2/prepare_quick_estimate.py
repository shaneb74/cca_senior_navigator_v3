...
def render_prepare_gate(recommendation_context: Optional[Any] = None) -> bool:
...
def _init_session_state(recommendation_context: Optional[Any]):
...
def _get_default_home_carry(zip_code: Optional[str]) -> float:
