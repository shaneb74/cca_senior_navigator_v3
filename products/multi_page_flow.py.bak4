...
def page_1():
    ...
    st.markdown(
        ...
        "<button style='font-size: 20px; padding: 10px 20px; background: #2563EB; color: white; border-radius: 5px; border: none;' onclick='window.location.reload()'>Start</button>"
        "</div>",
        unsafe_allow_html=True,
    )
...
def page_2():
    ...
    st.radio(
        "Are you seeking care for yourself or a loved one?",
        ["Myself", "A loved one"],
        key="q1",
    )
    ...
    st.radio(
        "Do you require memory care or specialized medical support?",
        ["Yes", "No"],
        key="q4",
    )
    st.radio(
        "Will you be paying privately or using insurance?",
        ["Privately", "Insurance"],
        key="q5",
    )
...
def page_3():
    ...
    st.radio(
        "What level of help is needed with daily activities?",
        ["Minimal", "Moderate", "Extensive"],
        key="q6",
    )
    st.radio(
        "Social engagement preferences?",
        ["Group activities", "Quiet environment"],
        key="q7",
    )
...
def page_5():
    ...
    st.markdown(
        ...
        "<button style='margin-right: 10px; background: #2563EB; color: white; border-radius: 5px; border: none;'>View recommended communities</button>"
        "<button style='background: #2563EB; color: white; border-radius: 5px; border: none;'>Restart</button>"
        "</div>",
        unsafe_allow_html=True,
    )
