...
def load_product_module_config(product: str, module: str) -> ModuleConfig:
    ...
    try:
        ...
        raise RuntimeError(f"Error calling {module_path}.get_config(): {e}") from e
...
def module_exists(product: str, module: str) -> bool:
    ...
    """
    module_dir = Path(__file__).parent.parent.parent / "products" / product / "modules" / module
...
def get_module_path(product: str, module: str) -> Path:
    ...
    """
    return Path(__file__).parent.parent.parent / "products" / product / "modules" / module
